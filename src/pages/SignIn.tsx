...
export const SignIn = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-100/80 via-blue-50/60 to-white">
