  ...
  return (
    <div className="relative">
      <select
        ...
        className={`w-full h-12 border-0 border-b-2 border-gray-200 rounded-none text-sm text-gray-600 bg-transparent transition-colors hover:bg-transparent placeholder-gray-200 focus:outline-none appearance-none pr-8 ${getFocusColor()}`}
      >
